  ...
  render() {
    ...
    return (
      <div className="movie-card">
        ...
        <CardFront poster={this.props.content.poster} />
        <CardBack genres={this.props.content.genres} title={this.props.content.title} IMDBRating={this.props.content.IMDBRating} />
      </div>
    )
  }
}
